...
function(e) {
    ...
    f.prototype = {
        ...
        defaultMessages: { required: "Недопустимый формат", email: "Please, type a valid email", maxLength: "Максимально колличесво символов: :value", minLength: "Минимальное колличесво символов: :value", password: "Password is not valid", remote: "Email already exists", strength: "Password must contents at least one uppercase letter, one lowercase letter and one number", "function": "Пожалуйста, введите корректный номер телефона" },
